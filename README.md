...
ComplimentMyClothes is a web application designed to support users in organizing and finding the perfect pairings for every article of clothing in their wardrobe. Each item is provided with a list of complimentary colours and items according to the current temperature, making getting dressed everyday easier! 
